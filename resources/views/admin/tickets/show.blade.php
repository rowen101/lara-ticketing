...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="mb-2">
            ...
            <ul class="nav nav-tabs mb-2">
                <li class="nav-item">
                    <div class="nav-link active" >Ticket Tread</div>
                </li>
            </ul>
                ...
                <div class="card-header">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-4">
                                <p class="font-weight-bold"><a href="mailto:{{ $comment->author_email }}">{{
                                    $comment->author_name }}</a> </p>
                            </div>
                        </div>
                    </div>
  ...
  <ul class="nav nav-tabs">
    <li class="nav-item">
      <a class="nav-link active" data-toggle="tab" href="#home">Post Replay</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" data-toggle="tab" href="#menu1">Reassign Ticket</a>
    </li>
